        ...
        <div style={{
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              {wallet.balance} <span style={{ fontSize: '1.25rem' }}>XRP</span>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{
          ...
          <div style={{ marginBottom: '3rem' }}>
            <label style={{ 
              ...
              Freelancer XRPL Address <span style={{ color: 'var(--error)' }}>*</span>
            </label>
            <input
              type="text"
              required
            ...
            <small style={{ 
              ...
              💡 Enter the freelancer's XRPL wallet address (must start with 'r' and be 25-34 characters)
            </small>
          </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
              <div>
                ...
                <div style={{ fontSize: '3rem', fontWeight: 700, color: 'var(--accent)', lineHeight: 1 }}>
                  {totalCost.toFixed(2)} <span style={{ fontSize: '1.5rem' }}>XRP</span>
                </div>
              </div>
